    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                app.post("/api/payment_check/:orderId", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                    var payload_1, orderId, updatedOrder, _a, SMTP_EMAIL, SMTP_PASSWORD, transporter, mailOptions;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                if (!(req.body.pay_status === "Successful")) return [3 /*break*/, 4];
                            ...
                            case 2:
                                updatedOrder = (_b.sent()).docs;
                                _a = process.env, SMTP_EMAIL = _a.SMTP_EMAIL, SMTP_PASSWORD = _a.SMTP_PASSWORD;
                                ...
                                mailOptions = {
                                    ...
                                    html: (0, ReceiptEmailHtml_1.ReceiptEmailHtml)({
                                        ...
                                        orderId: orderId,
                                        products: updatedOrder[0].products,
                                    }),
                                };
                                return [4 /*yield*/, transporter.sendMail(mailOptions)];
                            case 3:
                                _b.sent();
                                res.redirect("/thank-you/?orderId=".concat(orderId));
                                return [3 /*break*/, 5];
                            case 4:
                                res.redirect("/failed");
                                _b.label = 5;
                ...
                next_utils_1.nextApp.prepare().then(function () {
                    ...
                    app.listen(PORT, function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            payload.logger.info("Next.JS URL: ".concat(process.env.NEXT_PUBLIC_SERVER_URL));
                            return [2 /*return*/];
                        });
                    }); });
                });
